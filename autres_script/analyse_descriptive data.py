...
def lemme_dict(list_of_utterence):
    ...
    for phrase in tqdm(list_of_utterence[:10]): #[:10]
...
def brute_dict(list_of_utterence):
    ...
    dictionnaire = {}
    stopword = ['xxx' , 'x', 'xx', 'www' , 'nan' , 'yyy' , 'zzz']
    for phrase in tqdm(list_of_utterence[:1]): #[:]
...
# ---------------------------------------------------------
# Oppening, visualizing data and pretretement
# ---------------------------------------------------------
...
#final_dictionnaire = add_dict(all_utterances)
