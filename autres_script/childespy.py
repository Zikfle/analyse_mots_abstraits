...
info = get_db_info()
#get_transcripts(collection = None, corpus= None, target_child=None, connection= None, db_version = "current", db_args = None), connect_to_childes(db_version = "current", db_args = None)
#print(info)
#clear_connections()

connect_to_childes(db_version = "current", db_args = None)
collection = get_collections(connection = None, db_version = "current", db_args = None)

#print(collection)

corpora = get_corpora(connection = None, db_version = "current", db_args = None)
print(corpora)
liste_de_collection = collection['collection_name'].tolist()
#print(liste_de_collection)




liste_de_corpus = corpora['corpus_name'].tolist()
print(liste_de_corpus)


corpus_a_garder = ['Champaud', 'Geneva', 'Hunkeler', 'KernFrench', 'Pauline', 'Leveille', 'French-Lyon', 'Palasis', 'Paris', 
                   'Pauline', 'Yamaguchi', 'York', ]

corpus_french = get_utterances(collection = None, language = None, corpus = corpus_a_garder,
                           role = None, role_exclude = None, age = None,
                           sex = None, target_child = None, connection = None,
                           db_version = "current", db_args = None)

#print(corpus_french)
print(corpus_french.columns)
print(len(corpus_french))

#utterance = corpus_french['utterance']
corpus_french.to_csv('Data - corpus_french.csv')
